...
?>
    ...
    <body>
        ...
        <main class="row">
            <sidebar class="container col-12 col-sm-4 col-md-2 d-flex flex-column justify-content-between py-3 text-white vh-100">
            ...
            <article class="container col-12 col-sm-8 col-md-10 py-5">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-5 p-5">
                                    <img src="../images/<?= $pendaftar['foto_diri'] ?>" alt="Foto Profil" class="w-100 img-rofile">
                                </div>
                            </div>
