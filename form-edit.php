    ...
    <main class="container d-flex flex-column justify-content-center align-items-center vh-100">
        <div class="card border-0 shadow" id="frm-card">
            <div class="card-body p-5">
                ...
                <form action="proses_ubah.php?id=<?php echo $id; ?>" method="POST" id="frm-daftar" enctype="multipart/form-data">
                        ...
                        <tr>
                            <td class='text-center col-md-4 d-inline'>
                                <a href="list-siswa.php">
                                    <input type="submit" name="ubah" value="Ubah" class="fw-semibold btn" id="simpan-btn-2"></input>
                                </a>
                                <a href="list-siswa.php">
