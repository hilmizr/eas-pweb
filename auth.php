            ...
            <div class="container">
                <div class="row">
                    <div class="col-12" id="hero-content">
                        ...
                        <div>
                            <a href="form-daftar.php" class="fw-semibold btn btn-brand me-2" id="daftar-btn">Daftar</a>
                            <a href="list-siswa.php" class="fw-semibold btn btn-light ms-2" id="masuk-btn">Masuk</a>
                        </div>
                    </div>
                </div>
            </div>
